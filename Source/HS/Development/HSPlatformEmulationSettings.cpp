#include "HSPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(HSPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "HSCheats"

UHSPlatformEmulationSettings::UHSPlatformEmulationSettings()
{
}

FName UHSPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UHSPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UHSPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UHSPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UHSPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UHSPlatformEmulationSettings::PostInitProperties()
{
...
void UHSPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UHSPlatformEmulationSettings::ApplySettings()
{
...
void UHSPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UHSPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UHSPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UHSPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
