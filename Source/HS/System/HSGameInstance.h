...
UCLASS(Config = Game)
class HS_API UHSGameInstance : public UCommonGameInstance
{
	GENERATED_BODY()

public:
	UHSGameInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	AHSPlayerController* GetPrimaryPlayerController() const;
