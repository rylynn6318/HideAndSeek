...
#include "HSGameFeaturePolicy.generated.h"
...
class UHSGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	HS_API static UHSGameFeaturePolicy& Get();

	UHSGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
//UCLASS()
//class UHSGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
//{
//	GENERATED_BODY()
//
//public:
...
//
//UCLASS()
//class UHSGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
//{
//	GENERATED_BODY()
//
//public:
