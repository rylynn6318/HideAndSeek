 ...
 */
UCLASS()
class HS_API UHSWeaponInstance : public UHSEquipmentInstance
{
	GENERATED_BODY()

public:
	UHSWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FHSAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FHSAnimLayerSelectionSet UneuippedAnimSet;
