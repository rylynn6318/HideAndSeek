...
#include "HSRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UHSRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UHSRangedWeaponInstance : public UHSWeaponInstance, public IHSAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UHSRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~UHSEquipmentInstance interface
	virtual void OnEquipped();
	virtual void OnUnequipped();
	//~End of UHSEquipmentInstance interface

	void AddSpread();

	//~IHSAbilitySourceInterface interface
	...
	//~End of IHSAbilitySourceInterface interface
