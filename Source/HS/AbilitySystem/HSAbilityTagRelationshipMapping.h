...
#include "HSAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FHSAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UHSAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FHSAbilityTagRelationship> AbilityTagRelationships;
