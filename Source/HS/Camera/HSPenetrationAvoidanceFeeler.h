...
#include "HSPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FHSPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FHSPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
