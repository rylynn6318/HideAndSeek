#include "HSUserFacingExperienceDefinition.h"
#include "CommonSessionSubsystem.h"
#include "Containers/UnrealString.h"
#include "UObject/NameTypes.h"
#include "Engine/GameInstance.h"
#include "Engine/Engine.h"
//#include "Replays/HSReplaySubsystem.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(HSUserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* UHSUserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
	...
	//if (UHSReplaySubsystem::DoesPlatformSupportReplays())
	//{
	//	if (bRecordReplay)
	//	{
